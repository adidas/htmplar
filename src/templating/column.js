...
const Column = props => {
  ...
  return (
    <td valign={valign} className={classNames('htmplar-block-inner htmplar-cell', cellClasses, className)}>
      {children}
    </td>
  );
};
...
Column.propTypes = {
  children: PropTypes.oneOfType([PropTypes.object, PropTypes.symbol, PropTypes.func, PropTypes.array, PropTypes.string])
    .isRequired,
