...
const watch = linting => {
  const exec = [`node ${cliPath} build`, `node ${cliPath} serve`];

  if (typeof linting !== 'undefined' && (linting === true || Array.isArray(linting)) && linting[0] === true) {
