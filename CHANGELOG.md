...
## [2.0.0-alpha.7] - 2026-09-18

### Fixed
- **htmplar-cli**: Serve preview scripts as virtual modules so Vite can process bare imports (fixes React resolution)

## [2.0.0-alpha.6] - 2026-09-18

### Fixed
- **htmplar-cli**: Add React optimization to pre-bundle deps (fixes blank screen on dev server)

## [2.0.0-alpha.5] - 2026-09-18

### Fixed
- **htmplar-cli**: Downgraded Vite from v8 to v6 to fix rolldown native binding errors on macOS
- Resolved "Cannot find native binding" error when running `npm run dev`
- Resolved "Cannot find module '@rolldown/binding-wasm32-wasi'" error
