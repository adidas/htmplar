...
const Button = props => {
  ...
  }, icon && icon.index === 0 ? _react.default.createElement(_react.Fragment, null, _react.default.createElement("span", {
  ...
  }, text), icon && icon.index === 1 ? _react.default.createElement(_react.Fragment, null, _react.default.createElement("span", {
    className: "htmplar-button-spacer"
  }, "\xA0"), _react.default.createElement("span", {
    className: "htmplar-button-icon"
  }, icon.component)) : '')))))));
