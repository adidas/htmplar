...
const Button = props => {
  ...
  }, _react.default.createElement("table", null, _react.default.createElement("tr", null, icon && icon.index === 0 ? _react.default.createElement("td", {
    align: "left"
  ...
  }, "\xA0")) : '', _react.default.createElement("td", null, _react.default.createElement("a", {
    href: href,
    className: "htmplar-button-link"
  }, _react.default.createElement("span", {
